...
public class RunningStatusDialog {
	...
	public RunningStatusDialog(TrainRoute route,String position) {
		//configuring station 
		stationDialog = new JDialog();
		stationDialog.setTitle("Running Status");
		stationDialog.setSize(400,250);
		stationDialog.setDefaultCloseOperation(JDialog.HIDE_ON_CLOSE);
		panel = new JPanel();
		panel.setLayout(new GridBagLayout());
		panel.setBorder(BorderFactory.createLineBorder(Color.GRAY));
		stationDialog.add(panel);
